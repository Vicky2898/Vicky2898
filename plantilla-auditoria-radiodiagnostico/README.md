...
- **Descargar informe (PDF)**: genera un PDF directamente en el navegador (con [jsPDF](https://github.com/parallax/jsPDF), incluido en el propio archivo — no depende de internet ni del diálogo de impresión), con el detalle completo, resumen de cumplimiento y bloque de firmas (nombre precargado desde los datos ya ingresados). Es la forma recomendada de generar el informe.
